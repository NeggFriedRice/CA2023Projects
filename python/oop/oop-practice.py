...
# If the blueprint class Dog(argument1, argument2) does not receive 2 arguments, it will return an error because it can't create the dog with this blueprint
...
# greet(self, randomWord) will now look at the object (self AKA dog1) and can use any of its available attributes such as its name (self.name) and its age (self.age) as shown by print(dog1.__dict__); this is essentially substituted in as dog1.name and dog1.age. 
